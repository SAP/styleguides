...
- [테스트](#테스트)
    ...
    - [테스트 데이터](#테스트-데이터)
        ...
        - [Make it easy to spot differences](#차이점을-쉽게-이해할-수-있도록-테스트-데이터를-만들어라)
        - [Use constants to describe purpose and importance of test data](#테스트-데이터의-목적과-중요성을-설명할-때는-상수를-사용하라)
    - [Assertions](#어써션)
        ...
        - [Write custom asserts to shorten code and avoid duplication](#코드를-줄이고-중복을-피하기-위해-사용자-지정-어써션을-작성하라)

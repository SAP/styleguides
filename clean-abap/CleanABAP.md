...
> [Enumerations](sub-sections/Enumerations.md) explains the two variants
> and their advantages and disadvantages in detail.

#### Enumerations: Constant Pattern

> [Clean ABAP](#clean-abap) > [Content](#content) > [Constants](#constants) > [Prefer enumeration classes to constants interfaces](#prefer-enumeration-classes-to-constants-interfaces) > [This section](#enumerations-constant-pattern)
...
> [Clean ABAP](#clean-abap) > [Content](#content) > [Constants](#constants) > [Prefer enumeration classes to constants interfaces](#prefer-enumeration-classes-to-constants-interfaces) > [This section](#enumerations-object-pattern)
...
> [Clean ABAP](#clean-abap) > [Content](#content) > [Constants](#constants) > [Prefer enumeration classes to constants interfaces](#prefer-enumeration-classes-to-constants-interfaces) > [This section](#enumerations-anti-pattern)
...
> [Clean ABAP](#clean-abap) > [Content](#content) > [Constants](#constants) > [Prefer enumeration classes to constants interfaces](#prefer-enumeration-classes-to-constants-interfaces) > [This section](#enumerations-benefits)
